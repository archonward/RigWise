      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base leading-7 text-slate-300">
            ...
            and whether it is a faster variant. Use the name as a quick guide,
            then compare benchmarks before buying.
          </p>
        </div>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-lg border border-white/10 bg-slate-950/70 p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-300">
              Always check price, VRAM, power draw, case clearance, and real
              game benchmarks before choosing between nearby tiers.
            </p>
          </div>
        </div>
      </div>
